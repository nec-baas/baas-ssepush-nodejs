  ...
  function parseEventStreamLine (buf, pos, fieldLength, lineLength) {
    if (lineLength === 0) {
      if (data.length > 0) {
        ...
        _emit('message', new MessageEvent(type, { // ### always emit 'message', not type.
    ...
    } else if (fieldLength === 0) { // ### handling comment
      _emit('comment', null);
    }
  }
}
...
['open', 'error', 'message', 'comment'].forEach(function (method) { // ### add oncomment
